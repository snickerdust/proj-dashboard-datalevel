<x-app-layout>
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="container mx-auto p-6">
            <h1 class="max-w-7xl mx-auto sm:px-6 lg:px-8 text-white text-xl font-bold flex justify-center mb-10">Data Tabel Beli</h1>
            ...
            <div class="bg-[#1e2021] shadow-md rounded-lg">
                ...
                <div class="p-4 bg-[#111313] text-center">
                    {{ $dataBeli->links('pagination::tailwind') }}
                </div>
            </div>
